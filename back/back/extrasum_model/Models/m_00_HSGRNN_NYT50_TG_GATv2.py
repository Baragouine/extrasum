...
model.load(os.path.join(settings.BASE_DIR, "data/weights/01-HSGRNN_CNN_DailyMail.pt"))
...
def summary_model_text_delimiter(model, text, is_sep_n, trunc_doc=50):
  ...
  doc = preprocess_text(text, glovemgr, is_sep_n, remove_stop_word=True, stemming=False, trunc_sent=-1, padding_sent=-1)
