...
from .utils_fr.create_graph_dataset import create_graph_dataset
from .utils_fr.EmbMgr import EmbMgr
from .utils_fr.DataLoader import DataLoader
from .utils_fr.accuracy_nb_sent_per_doc import accuracy_nb_sent_per_doc_fn
from .utils_fr.split_all_docs import split_all_docs
from .utils_fr.threshold_probs import threshold_probs_by_nb, threshold_probs_by_prop
from .utils_fr.accuracy_prop_sent_per_doc import accuracy_prop_sent_per_doc_fn
from .utils_fr.preprocess_text import preprocess_text
from .utils_fr.create_graph_dataset import create_graph
...
embmgr = EmbMgr(os.path.join(settings.BASE_DIR, "data/cc.fr.300.vec"), vocab_size=vocab_size, header=True)
...
model.load(os.path.join(settings.BASE_DIR, "data/weights/02-HSGRNN_WikiGeoFr.pt"))
...
def summary_model_text_delimiter(model, text, is_sep_n, trunc_doc=50):
  ...
  graph = create_graph(truncated_doc, tfidf_doc, embmgr, pad_sent=pad_sent, word_blacklist=[], remove_unkn_words=False, self_loop=False)
...
def summary_with_HSGRNN_WikiGeo(text, is_sep_n):
